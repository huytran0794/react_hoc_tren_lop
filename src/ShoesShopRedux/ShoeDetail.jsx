...
class ShoeDetail extends Component {
  render() {
    let { image, name, price, description, quantity } = this.props.shoeDetail;
    console.log(this.props.shoeDetail);
    return (
      <div
...
let mapStatetoProps = (state) => {
  return {
    shoeDetail: state.shoeReducer.currentShoe,
  };
};

export default connect(mapStatetoProps)(ShoeDetail);
